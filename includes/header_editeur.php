                ...
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav me-auto mb-lg-0 w-100 text-center container-fluid-md  row justify-content-center">
                        <li class="nav-item col-md-3">
                            <a class="nav-link <?php echo $ok =  ($actif =="admin" || $actif=="register") ? 'text-actif' : 'menu-text text-dark' ; ?>" href="./">Intelligences</a>
                        </li>
                        <li class="nav-item col-md-3">
                            <a class="nav-link <?php echo $ok =  ($actif =="echec") ? 'text-actif' : 'menu-text text-dark' ; ?>" href="./echec.php">Echecs</a>
                        </li>
                        <li class="nav-item col-md-3">
