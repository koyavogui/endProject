<?php
    ...
    echo '<table class="table border-dark table-sm">
            ...
            if($cle == 1) {
                ...
                echo'<li class="page-item" id="'. $cle - 1 .'" onclick="pagination(this.id , \'tabuser\')"><span class="page-link border-0"><i class="bi bi-caret-left-fill"></i></span></li>'; 
            }
            ...
            if($cle == $nombredepage) {
                ...
                echo'<li class="page-item" id="'. $cle+ 1 .'" onclick="pagination(this.id , \'tabuser\')"><span class="page-link border-0"><i class="bi bi-caret-right-fill"></i></span></li>';
            }
            echo '</ul>
          </nav>';
